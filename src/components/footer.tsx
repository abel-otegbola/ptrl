    ...
    return (
        <footer className="flex flex-col items-center text-center gap-8 md:px-12 px-4 py-20">
            ...
            <div className="flex flex-col gap-4 py-8 uppercase text-[#989898]">
                ...
                <p>that&apos;s how we built <span className="text-[#c22026]">ptrl</span> - a lagos-born streetwear brand built for the bold, the relentless, the ones who move different.</p>
